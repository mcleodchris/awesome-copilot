# awesome-copilot
A list of awesome GitHub Copilot resources I've found useful or enlightening. If you know of any others, please help expand the list by raising an Issue, or creating a PR.
...
- [Introduction to Prompt Engineering with GitHub Copilot](https://learn.microsoft.com/en-gb/training/modules/introduction-prompt-engineering-with-github-copilot/)
- [Using GitHub Copilot with JavaScript](https://learn.microsoft.com/en-gb/training/modules/introduction-copilot-javascript/)
- [Using GitHub Copilot with Python](https://learn.microsoft.com/en-gb/training/modules/introduction-copilot-python/)
- [Challenge project - Build a minigame with GitHub Copilot and Python](https://learn.microsoft.com/en-gb/training/modules/challenge-project-create-mini-game-with-copilot/)
- [Guided project - Build auto suggest engine with Copilot](https://learn.microsoft.com/en-gb/training/modules/build-auto-suggest-engine-copilot/)

## Videos
### Official Microsoft/GitHub
- [Copilot Best Practices (What Not To Do) - Visual Studio Code](https://youtu.be/2q0BoioYSxQ?si=67wYsDJW7P6Tbdg1)
...
- [/slash commands (VS Code documentation)](https://code.visualstudio.com/docs/copilot/copilot-chat#_slash-commands)
